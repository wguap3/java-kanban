...
public class Main {
    public static void main(String[] args) {
        ...
        Task task3 = new Task("Задача 3", "Описание 3", null, TaskStatus.NEW, Duration.ofDays(2), LocalDateTime.of(2023, 1, 1, 1, 1));
        taskManager.addTask(task1);
        taskManager.addTask(task2);
        taskManager.addTask(task3);

        Epic epic1 = new Epic("Эпик 1", "Описание эпика", null, TaskStatus.NEW);
        Epic epic2 = new Epic("Эпик 1", "Описание эпика", null, TaskStatus.NEW, taskManager);
        Epic epic3 = new Epic("Эпик 1", "Описание эпика", null, TaskStatus.NEW, taskManager);
